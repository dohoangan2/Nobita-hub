...
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/Nchanquadi/Smlptessr/main/sk
%20an%20cac%20do%20em.txt"))()
----------------------------------------------------------------------------------------------------------------------------------------------

local Window = Fluent:CreateWindow({
    Title = "Nobita hub",
    SubTitle = "Do Hoang An",
    TabWidth = 145,
...
L_92_.Image = "rbxassetid://17619416003"
